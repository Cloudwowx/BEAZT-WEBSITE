...
def settings():
    ...
    return render_template("admin/settings.html",
        ...
        payfast_merchant_id=Setting.get("payfast_merchant_id", ""),
        payfast_merchant_key=Setting.get("payfast_merchant_key", ""),
        payfast_passphrase=Setting.get("payfast_passphrase", ""),
